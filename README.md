# 📊 Projets Data Mining & Machine Learning — UFRJ

Ce dépôt regroupe 6 projets de Data Mining et de Machine Learning réalisés à l’Université Fédérale de Rio de Janeiro (UFRJ) pendant mon semestre d’échange 2025.1. Chaque projet est présenté sous forme de notebook Jupyter, en portugais, avec des traductions en anglais et en français.
...
```plaintext
notebooks/
├── pt/  → Versions originales en portugais
...
| Prédiction du risque d’obésité pour prévenir les maladies cardiovasculaires | [Voir notebook](notebooks/fr/Notebook_obesityrRisk_fr.ipynb) | [Ver notebook](notebooks/br/Notebook_obesityrRisk_br.ipynb) | [View notebook](notebooks/en/Notebook_obesityrRisk_en.ipynb) |
| Régression multivariée pour l’estimation du prix de biens immobiliers | [Voir notebook](notebooks/fr/Notebook_realEstate_fr.ipynb) | [Ver notebook](notebooks/br/Notebook_realEstate_br.ipynb) | [View notebook](notebooks/en/Notebook_realEstate_en.ipynb) |
